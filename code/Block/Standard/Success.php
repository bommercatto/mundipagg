...
class Uecommerce_Mundipagg_Block_Standard_Success extends Mage_Core_Block_Template {
    /**
    ...
    **/
    public function getBoletoUrl() 
    {
        ...
        if ($session->getLastRealOrderId()) {
            ...
            $boleto = $order->getPayment()->getAdditionalInformation('Boleto'); 

            return $boleto[0]->BoletoUrl;
        }
    }
}